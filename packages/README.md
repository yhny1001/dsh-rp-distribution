...
See the repository [architecture](../docs/architecture.md), [Host compatibility](../docs/compatibility.md), and complete [infrastructure development guide](../docs/development.md). Before writing code, distinguish infrastructure plugins that receive Cordis `ctx` from installable RP packages that never receive `ctx`.
