 ...
 * ([rationale](../../.agents/notes/implemented/architecture/2026-08-17-plugin-only-repository.md)).
 */
...
function main(): void {
  ...
  if (values.family === undefined) throw new Error('usage: pack.ts --family rp [--out dist/npm]')
